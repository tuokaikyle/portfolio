...
export const front = {
  title: 'Welcome',
  subtitle: 'A portfolio website using React and Tailwind',
  content: [
    ...
    'Please feel free to read more about me and checkout my CV & projects. Cheers!',
  ],
};

export const resume = {
  //  I listed 8 courses here. No need to have too much.
  courses: [
    {
  ...
  experiences: [
    {
      ...
      daterange: '2018 - 2020',
      points: [
        'Responsible for after-hours student and property care',
        'Organised residential activities and events',
      ],
    },
    {
...
export const project = [
  ...
  {
    title: 'Tomato',
    subtitle: 'A todo app with Quadrants of time management',
